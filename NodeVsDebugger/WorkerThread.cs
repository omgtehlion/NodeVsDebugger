...
namespace NodeVsDebugger
{
    ...
    public class WorkerThread : IDisposable
    {
        ...
        readonly Action m_quitOperation;
        ...
        public void RunOperation(Action op)
        {
            if (op == null)
        ...
        public void RunOperationAsync(Action op)
        {
            if (op == null)
                throw new ArgumentNullException();
        ...
        internal void SetOperationInternal(Action op, bool fSyncOp)
        {
            while (true) {
        ...
        bool TrySetOperationInternal(Action op, bool fSyncOp)
        {
        ...
        private void ThreadFunc()
        {
            ...
            while (!fQuit) {
                ...
                //    m_debuggedProcess.WaitForAndDispatchDebugEvent();
                //}

                // If the other thread is dispatching a command, execute it now.
                var fReceivedCommand = m_opSet.WaitOne(new TimeSpan(0, 0, 0, 0, 100), false);
