...
namespace NodeVsDebugger
{
    ...
    class AD7Enum<T, I> where I : class
    {
        ...
        public AD7Enum(IEnumerable<T> data)
        {
            m_data = data.ToArray();
            m_position = 0;
        }
    ...
    {
        public AD7ProgramEnum(IEnumerable<IDebugProgram2> data) : base(data) { }
    ...
    {
        public AD7FrameInfoEnum(IEnumerable<FRAMEINFO> data) : base(data) { }
    ...
    {
        public AD7PropertyInfoEnum(IEnumerable<DEBUG_PROPERTY_INFO> data) : base(data) { }
    }

    class AD7ThreadEnum : AD7Enum<IDebugThread2, IEnumDebugThreads2>, IEnumDebugThreads2
    {
        public AD7ThreadEnum(IEnumerable<IDebugThread2> data) : base(data) { }
    ...
    {
        public AD7ModuleEnum(IEnumerable<IDebugModule2> data) : base(data) { }
    ...
    {
        public AD7PropertyEnum(IEnumerable<DEBUG_PROPERTY_INFO> data) : base(data) { }
    }

    class AD7CodeContextEnum : AD7Enum<IDebugCodeContext2, IEnumDebugCodeContexts2>, IEnumDebugCodeContexts2
    {
        public AD7CodeContextEnum(IEnumerable<IDebugCodeContext2> data) : base(data) { }
    ...
    {
        public AD7BoundBreakpointsEnum(IEnumerable<IDebugBoundBreakpoint2> data) : base(data) { }
